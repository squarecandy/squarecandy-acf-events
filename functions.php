...
function squarecandy_acf_events_enqueue_scripts() {
	...
	wp_enqueue_style( 'squarecandy-fontawesome', ACF_EVENTS_URL . 'dist/css/vendor/font-awesome/css/font-awesome.min.css', false, 'version-1.4.0' );
	wp_enqueue_style( 'squarecandy-acf-events-css', ACF_EVENTS_URL . 'dist/css/main.min.css', false, 'version-1.4.0' );
	...
	wp_enqueue_script( 'squarecandy-acf-events-js', ACF_EVENTS_URL . 'dist/js/main.min.js', array( 'jquery' ), 'version-1.4.0', true );
	wp_localize_script(
...
function squarecandy_acf_events_admin_enqueue() {
	wp_enqueue_style( 'squarecandy-acf-events-admin-css', ACF_EVENTS_URL . 'dist/css/admin.min.css', false, 'version-1.4.0' );
	wp_enqueue_script( 'squarecandy-acf-events-admin-js', ACF_EVENTS_URL . 'dist/js/admin.min.js', array( 'jquery' ), 'version-1.4.0', true );
}
...
if ( ! get_transient( 'squarecandy_event_cleanup_complete5' ) ) {
	...
	function squarecandy_acf_events_bulk_update_enqueue() {
		wp_enqueue_script( 'squarecandy-acf-events-bluk-update-js', ACF_EVENTS_URL . 'dist/js/bulk-update.min.js', array( 'jquery' ), 'version-1.4.0', true );
