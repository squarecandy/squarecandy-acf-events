...
if ( ! function_exists( 'squarecandy_get_countries' ) ) :
	function squarecandy_get_countries() {
		...
		$countries = array(
			...
			'British Antarctic Territory'                  => __( 'British Antarctic Territory', 'squarecandy' ),
			...
			'Canton and Enderbury Islands'                 => __( 'Canton and Enderbury Islands', 'squarecandy' ),
			...
			'Congo - Brazzaville'                          => __( 'Congo - Brazzaville', 'squarecandy' ),
			'Congo - Kinshasa'                             => __( 'Congo - Kinshasa', 'squarecandy' ),
			...
			'Czech Republic'                               => __( 'Czech Republic', 'squarecandy' ),
			...
			'Dronning Maud Land'                           => __( 'Dronning Maud Land', 'squarecandy' ),
			...
			'French Southern Territories'                  => __( 'French Southern Territories', 'squarecandy' ),
			...
			'Hong Kong S.A.R., China'                      => __( 'Hong Kong S.A.R., China', 'squarecandy' ),
			...
			'Johnston Island'                              => __( 'Johnston Island', 'squarecandy' ),
			...
			'Macau SAR China'                              => __( 'Macau SAR China', 'squarecandy' ),
			'Macedonia'                                    => __( 'Macedonia', 'squarecandy' ),
			...
			'Metropolitan France'                          => __( 'Metropolitan France', 'squarecandy' ),
			'Mexico'                                       => __( 'Mexico', 'squarecandy' ),
			'Micronesia'                                   => __( 'Micronesia', 'squarecandy' ),
			'Midway Islands'                               => __( 'Midway Islands', 'squarecandy' ),
			...
			'Netherlands Antilles'                         => __( 'Netherlands Antilles', 'squarecandy' ),
			'Neutral Zone'                                 => __( 'Neutral Zone', 'squarecandy' ),
			...
			'North Vietnam'                                => __( 'North Vietnam', 'squarecandy' ),
			'Northern Mariana Islands'                     => __( 'Northern Mariana Islands', 'squarecandy' ),
			'Norway'                                       => __( 'Norway', 'squarecandy' ),
			'Oman'                                         => __( 'Oman', 'squarecandy' ),
			'Pacific Islands Trust Territory'              => __( 'Pacific Islands Trust Territory', 'squarecandy' ),
			...
			'Panama Canal Zone'                            => __( 'Panama Canal Zone', 'squarecandy' ),
			'Papua New Guinea'                             => __( 'Papua New Guinea', 'squarecandy' ),
			'Paraguay'                                     => __( 'Paraguay', 'squarecandy' ),
			'People\'s Democratic Republic of Yemen'       => __( 'People\'s Democratic Republic of Yemen', 'squarecandy' ),
			...
			'Serbia and Montenegro'                        => __( 'Serbia and Montenegro', 'squarecandy' ),
			...
			'Swaziland'                                    => __( 'Swaziland', 'squarecandy' ),
			...
			'U.S. Miscellaneous Pacific Islands'           => __( 'U.S. Miscellaneous Pacific Islands', 'squarecandy' ),
			'U.S. Virgin Islands'                          => __( 'U.S. Virgin Islands', 'squarecandy' ),
			'Uganda'                                       => __( 'Uganda', 'squarecandy' ),
			'Ukraine'                                      => __( 'Ukraine', 'squarecandy' ),
			'Union of Soviet Socialist Republics'          => __( 'Union of Soviet Socialist Republics', 'squarecandy' ),
			...
			'Unknown or Invalid Region'                    => __( 'Unknown or Invalid Region', 'squarecandy' ),
			...
			'Wake Island'                                  => __( 'Wake Island', 'squarecandy' ),
